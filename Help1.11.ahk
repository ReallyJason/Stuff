    ...
    Gui, Main: Add, Button, gButton49, Foraging
    ...
    Gui, Screen1: Add, Text,, Cocoa=295 Cactus=464 Shroom=232 -16/5.5
...
Button7:
    ...
    Global sleepTimeUp := 43000
    Global sleepTimeDown := 43000
    Return
...
Button9:
    ...
    Global sleepTimeUp := 56000
    Global sleepTimeDown := 56000
    Return
...
;---------------------------------------------------------------------------------------------color
    BlueBack(){
        PixelSearch, gx, gy, 656, 542, 1042, 624, 0x55FFFF, 0, Fast RGB
        if (ErrorLevel = 0){
            Return true
        }
    }
    BlueFront(){
        PixelSearch, gx, gy, 656, 542, 1042, 624, 0x153F3F, 0, Fast RGB
        if (ErrorLevel = 0){
            Return true
        }
    }
    ...
    CheckYellowSide(){
        ...
        PixelSearch, gx, gy, 0, 0, A_ScreenWidth, A_ScreenHeight, 0xC8A612, 0, Fast RGB;
        if (ErrorLevel = 0){
            Return true
        }
    }
